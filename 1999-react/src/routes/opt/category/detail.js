...
class OptCategoryDetail extends React.Component {
  constructor(props) {
    super(props);
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(OptCategoryDetail);
